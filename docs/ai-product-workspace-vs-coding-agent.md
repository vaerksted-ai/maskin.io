...
This piece is the tier-1 leg of the [three tiers of AI-native work](/docs/three-tiers-ai-native-work/) framework — the tier whose object of work is a coding task and whose terminal event is a merged PR.
