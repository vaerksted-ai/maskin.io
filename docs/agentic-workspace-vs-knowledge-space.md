...
Self-host Maskin today, or take a hosted trial. Run your knowledge space where you already have one and let Maskin close the loop on the decisions the team ships. The [agentic-workspace cornerstone](/docs/what-is-an-agentic-workspace/) and the [bet-based product planning](/docs/bet-based-product-planning/) guide are the two best next reads.
