...
The frame did not originate here. MIT Technology Review’s April 16, 2026 piece on the illusion of AI oversight made the point plainly: humans nominally in the loop but operating under workflow pressure and without meaningful visibility produce the appearance of oversight, not the substance.[1](#fn1) Verfassungsblog coined the phrase that captures the failure mode — the **“warm body in the loop”** — a person whose role fails on first audit because nothing about the workflow lets them meaningfully intervene.[2](#fn2)
...
## Sources
1. **Stephanie Arnett / MIT Technology Review**, *Why having “humans in the loop” in an AI war is an illusion* (2026-04-16). [technologyreview.com/2026/04/16/1136029/humans-in-the-loop-ai-war-illusion](https://www.technologyreview.com/2026/04/16/1136029/humans-in-the-loop-ai-war-illusion/). Source for the illusion-of-oversight framing — a human nominally in the loop but under workflow pressure and without visibility provides the appearance of oversight, not the substance. [↩](#fnref1)
2. **Verfassungsblog**, *A Warm Body in the Loop: Rethinking Human Control of AI in EU Tech Regulation*. [verfassungsblog.de/warm-body-in-the-loop](https://verfassungsblog.de/warm-body-in-the-loop/). Source of the “warm body in the loop” phrase — a person whose oversight role fails on first audit because the workflow does not let them meaningfully intervene. [↩](#fnref2)
3. **Harrison Chase / LangChain**, *Introducing Ambient Agents* (Jan 2025). [langchain.com/blog/introducing-ambient-agents](https://www.langchain.com/blog/introducing-ambient-agents). Definitional citation for the human-on-the-loop vs human-in-the-loop shift and the ambient-agent design pattern. [↩](#fnref3)
4. **OpenAI case study**, *Morgan Stanley uses AI evals to shape the future of financial services*. [openai.com/index/morgan-stanley](https://openai.com/index/morgan-stanley/). Public description of Morgan Stanley’s internal AI deployment — advisors retain approval on client-facing outputs; the model runs bulk research-summarisation and internal document work. [↩](#fnref4)
Read next
